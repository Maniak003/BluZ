...
E_REF = [30, 50, 80, 100, 150, 200, 300, 400, 500, 662, 1000, 1332, 2000, 2614, 3000, 3500];
...
title('Chi Vector: NaI(Tl) 10×40 mm');
grid on; xlim([0, 3.5]);

%% ==================== 6. СОХРАНЕНИЕ ДЛЯ MATLAB ====================
save('dose_weights_NaI_10x40.mat', 'w', 'bin_centers', 'LAMBDA', 'energies_keV');
fprintf('\n=== Готово ===\n');
fprintf('Бинарный файл: %s (загрузите в Android через loadChiFile)\n', filename_bin);
fprintf('MAT-файл: dose_weights_NaI_10x40.mat (для отладки в MATLAB)\n');
