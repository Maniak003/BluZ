...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* hadc)
{
  ...
  /* USER CODE END ADC4_MspDeInit 0 */
    ...
    PA0     ------> ADC4_IN9
    */
    HAL_GPIO_DeInit(GPIOA, batLev_Pin|AIn_Pin);
...
void HAL_SPI_MspInit(SPI_HandleTypeDef* hspi)
{
  ...
  */
    ...
    */
    ...
    GPIO_InitStruct.Pin = DISPLAY_SI_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    GPIO_InitStruct.Alternate = GPIO_AF5_SPI1;
    HAL_GPIO_Init(DISPLAY_SI_GPIO_Port, &GPIO_InitStruct);
...
void HAL_SPI_MspDeInit(SPI_HandleTypeDef* hspi)
{
  ...
  /* USER CODE END SPI1_MspDeInit 0 */
    ...
    PA15 (JTDI)     ------> SPI1_MOSI
    */
    HAL_GPIO_DeInit(DISPLAY_SCK_GPIO_Port, DISPLAY_SCK_Pin);

    HAL_GPIO_DeInit(DISPLAY_SI_GPIO_Port, DISPLAY_SI_Pin);
