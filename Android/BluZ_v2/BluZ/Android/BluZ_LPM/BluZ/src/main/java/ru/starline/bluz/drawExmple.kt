...
/**
 * Превью-канвас для предварительного просмотра цветов в Settings — карточка «Спектр».
 *
 * Имеет искусственный сигнал (линейный 0..199) + сдвинутый фон (50..199). Перерисовывается
 * через [exampRedraw] при изменении любого из цветов в SeekBar (R/G/B/A для линейного,
 * лог, фон-линейный, фон-лог × 2 стиля = 8 цветов).
 */
class drawExmple {
